...
### Uncomment the following files for execution
- Assessment\src\features\BrightHorizon\HomeScreen.feature
- Assessment\src\locators\getElementLocators.ts
- Assessment\src\locators\HomeScreen_Locators.ts
- Assessment\src\steps\HomeScreen-steps.ts
- Assessment\src\utilities\homeUtility.ts
- Assessment\src\utilities\htmlReporter.ts
- Assessment\tsconfig.json
- Assessment\package-lock.json
- Assessment\src\utilities\htmlReporter.ts
- Assessment\src\config\base.config.ts
- Assessment\src\config\environment.ts
- Assessment\src\config\local.config.ts
 -->
